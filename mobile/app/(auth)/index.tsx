...
import { AnimatedOrb } from '@/components/AnimatedOrbs';
      ...
      <SafeAreaView className='flex-1'>
        ...
        <View className='flex-1 px-6 justify-center items-center'>
          ...
          <View className='flex-row gap-4 mt-10'>
            ...
            {/* Apple Btn */}
            <Pressable
              className='flex-1 flex-row items-center justify-center gap-2 border-white/20 bg-white/10 py-4 rounded-2xl active:scale-[0.97]'
